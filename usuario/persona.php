...
<body>
    ...
    <a href="inicio.php" id="hist">Volver</a>
    ...
    <div class="container">
    <h2>Mi Historial en el Movimiento Scout</h2>
    <table>
        <tr>
            <th>Rama</th>
            <th>Campamento</th>
        ...
        $sql2 = "SELECT campamento, lugar, anio, ramas.id_rama,ramas.nombre AS nombre_rama FROM integrantes_berthier,historial,ramas WHERE integrantes_berthier.id = '$id' AND historial.id_joven = '$id' AND integrantes_berthier.rama_id = ramas.id_rama";
