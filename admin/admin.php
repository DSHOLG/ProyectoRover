...
<body>
    ...
    <section class="articles">
        ...
        <article class="article" id="persona">
            ...
            <a href="historiales.php">Insertar</a>
            <a href="buscador.php">Buscador</a>
            <a href="subirFotos.php"> Agregar Fotos</a>
        </article>
        ...
        <article class="article" id="berthier">
            ...
            <a href="verFotos.php?id_rama=6">Ver Fotos!</a>
        </article>
        ...
        <article class="article" id="manada">
            ...
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla fringilla mauris a justo vestibulum, eu lacinia justo bibendum.</p>
            <a href="verfotos2.php?id_rama=1">Ver Fotos!</a>
        </article>
        ...
        <article class="article" id="unidad">
            ...
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla fringilla mauris a justo vestibulum, eu lacinia justo bibendum.</p>
            <a href="verfotos2.php?id_rama=2">Ver Fotos!</a>
        </article>
        ...
        <article class="article" id="caminantes">
            ...
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla fringilla mauris a justo vestibulum, eu lacinia justo bibendum.</p>
            <a href="verfotos2.php?id_rama=3">Ver Fotos!</a>
        </article>
        ...
        <article class="article" id="rover">
            ...
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla fringilla mauris a justo vestibulum, eu lacinia justo bibendum.</p>
            <a href="verfotos2.php?id_rama=4">Ver Fotos!</a>
        </article>
    </section>
